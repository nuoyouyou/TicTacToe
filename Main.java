...
class TicTacToe {
    ...
    public void playTicTacToe() {
        ...
        System.out.println("Anti-Tic-Tac-Toe: Get 4 in a row to WIN, but getting exactly 3 in a row makes you LOSE!");
